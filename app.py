...
if "chat_history" not in st.session_state:
    st.session_state.chat_history = [
        AIMessage(content="Hello! I am your own personal SQL assistant. Ask me anything about your database"),
    ]
load_dotenv()
...
##sidebar to connect to database
with st.sidebar:
    ...
    st.text_input("User", value="practice", key="User")
...
## chat input and chat history messages
